...
subtitle: "Guide to unlocking your inner Bionformatian  "
...
[![Prezi Overview](Session%200%20Logging%20on%20to%20your%20personal%20Cloud%20Image/Images/Prezi_Overview.png){fig-alt="Prezi Overview" fig-align="center"}](https://prezi.com/view/PJXGFaOeSh7r9EsmBCD1/)
...
![Prezi Zooming In for Resources and Links](Session%200%20Logging%20on%20to%20your%20personal%20Cloud%20Image/Images/Prezi_zoom.png){fig-alt="Prezi Zooming In for Resources and Links" fig-align="center"}
...
## [Linux The basics](https://peter-kille.github.io/Bioinformatics_Teaching_Repo//1_Linux_NGS_Data_and_QC/Session1_Part1_Linux.html)

This introduces you to the command line - yes no clicking on icons it is all about writing commands !!  We try and cover the basics of navigating around your linux system, auto-completion, file permissions and the fundamental anatomy of a linux command. We cover simple commands  (copy/move ect), how to preview files (less/cat/head/tail) and how to edit file (we use Nano but look into Vi).
